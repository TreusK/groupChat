...
function SimpleCard({ icon }) {
  ...
  return (
    <div className='bg-[#F7F7F7] flex md:flex-col justify-around items-center p-6 w-[365px] h-[220px] md:w-[250px] md:h-[330px] rounded-lg border border-solid shadow border-[#8D8E8F] scale-75 xs:transform-none'>
      {icon === 'star' &&
        <>
      ...
      {icon === 'flag' &&
        <>
          ...
          <div className='w-[2px] h-1/2 bg-gray-200 md:w-1/2 md:h-[2px]'></div>
          <div className='cardBody text-center flex-[8] pl-2 md:pl-0'>
            <h2 className='text-xl p-4'>Foreigners galore</h2>
